            ...
            <div class="col">
                <div class="form-group">
                    <div class="input-group input-group-alternative">
                        ...
                        <input class="form-control" id="startDate" placeholder="Fecha de inicio" type="text"
                            value="{{ $start }}">
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <div class="input-group input-group-alternative">
                        ...
                        <input class="form-control" id="endDate" placeholder="Fecha de fin" type="text"
                            value="{{ $end }}">
                    </div>
                </div>
            </div>
...
function fetchData() {
    ...
    // Fetch API
    const url = `../doctors/column/data?start=${startDate}&end=${endDate}`;
